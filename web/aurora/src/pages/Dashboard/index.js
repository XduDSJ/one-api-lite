          ...
          {summaryCards.map((card) => (
            <Grid.Column key={card.key}>
              <Card fluid className='chart-card' style={{ borderTop: `3px solid ${card.color}` }}>
                <Card.Content>
                  <div style={{ color: 'var(--aurora-text-muted)', fontSize: '14px', fontWeight: 500, marginBottom: '8px' }}>
                    {t(`dashboard.overview.${card.key}`)}
                  </div>
                  <div style={{ color: 'var(--aurora-text)', fontSize: '28px', fontWeight: 700, lineHeight: 1.2 }}>
                ...
                <div className='chart-container'>
                  <ResponsiveContainer width='100%' height={220}>
                    <LineChart data={dailyData} margin={{ left: 10, right: 10 }}>
                      ...
                      <Tooltip contentStyle={{ background: 'var(--aurora-surface-2)', border: 'none', borderRadius: '4px', boxShadow: '0 2px 8px rgba(0,0,0,0.1)' }} formatter={(value) => [value, t('dashboard.overview.daily_requests')]} labelFormatter={(label) => `${t('dashboard.statistics.tooltip.date')}: ${formatDate(label)}`} />
                ...
                <div className='chart-container'>
                  <ResponsiveContainer width='100%' height={220}>
                    <LineChart data={dailyData} margin={{ left: 10, right: 10 }}>
                      ...
                      <XAxis dataKey='day' axisLine={false} tickLine={false} tick={{ fontSize: 12, fill: '#A3AED0' }} tickFormatter={formatDate} interval={0} minTickGap={5} padding={{ left: 20, right: 20 }} />
                      <YAxis axisLine={false} tickLine={false} tick={{ fontSize: 12, fill: '#A3AED0' }} />
                      <Tooltip contentStyle={{ background: 'var(--aurora-surface-2)', border: 'none', borderRadius: '4px', boxShadow: '0 2px 8px rgba(0,0,0,0.1)' }} formatter={(value) => [value, t('dashboard.overview.daily_tokens')]} labelFormatter={(label) => `${t('dashboard.statistics.tooltip.date')}: ${formatDate(label)}`} />
                ...
                <div className='chart-container'>
                  <ResponsiveContainer width='100%' height={320}>
                    <BarChart data={modelDist} margin={{ left: 10, right: 20, bottom: 10 }}>
                      ...
                      <YAxis axisLine={false} tickLine={false} tick={{ fontSize: 12, fill: '#A3AED0' }} />
                      <Tooltip contentStyle={{ background: 'var(--aurora-surface-2)', border: 'none', borderRadius: '4px', boxShadow: '0 2px 8px rgba(0,0,0,0.1)' }} cursor={{ fill: 'rgba(67, 24, 255, 0.05)' }} />
                ...
                <div className='chart-container'>
                  <ResponsiveContainer width='100%' height={320}>
                    <BarChart data={channelDist} margin={{ left: 10, right: 20, bottom: 10 }}>
                      ...
                      <XAxis dataKey='name' {...distXAxisConfig} />
                      <YAxis axisLine={false} tickLine={false} tick={{ fontSize: 12, fill: '#A3AED0' }} />
                      <Tooltip contentStyle={{ background: 'var(--aurora-surface-2)', border: 'none', borderRadius: '4px', boxShadow: '0 2px 8px rgba(0,0,0,0.1)' }} cursor={{ fill: 'rgba(0, 181, 216, 0.05)' }} />
